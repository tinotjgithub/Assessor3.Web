...
/* This will find the fracion of HTML Elements */
/* tslint:disable */
...
(function () {
    ...
    extend(Rect.prototype, {
        ...
        intersection: function (rect) {
            ...
            let left = mathMax(this.left, rect.left);
            let right = mathMin(this.right, rect.right);
            let top = mathMax(this.top, rect.top);
            let bottom = mathMin(this.bottom, rect.bottom);
        ...
        envelope: function (rect) {
            ...
            let left = mathMin(this.left, rect.left);
            let right = mathMax(this.right, rect.right);
            let top = mathMin(this.top, rect.top);
            let bottom = mathMax(this.bottom, rect.bottom);
            let width = right - left;
            let height = bottom - top;
    ...
    extend(Fractions, {
        ...
        of: function (rect, viewport) {
            ...
            let intersection, intersectionArea, possibleArea;

            rect = (isHTMLElement(rect) && (Rect as any).ofElement(rect)) || rect;
            viewport = (isHTMLElement(viewport) && (Rect as any).ofViewport(viewport)) || viewport || (Rect as any).ofViewport();

            if (!(rect instanceof Rect)) {
                return new Fractions(null,null,null,null);
            }
    ...
    let rectProps = ['width', 'height', 'left', 'right', 'top', 'bottom'];
    let fracsProps = ['possible', 'visible', 'viewport'];
    ...
    function getValue(element, viewport, property) {
        ...
        if ($.inArray(property, rectProps) >= 0) {
            obj = (Rect as any).ofElement(element);
        } else if ($.inArray(property, fracsProps) >= 0) {
            obj = (Fractions as any).of(element, viewport);
        }
    ...
    function ScrollState(element) {
        ...
        let content = (Rect as any).ofContent(element, true);
        let viewport = (Rect as any).ofViewport(element, true);
        let w = content.width - viewport.width;
        let h = content.height - viewport.height;
    ...
    extend(Viewport.prototype, {
        ...
        scrollTo: function (left, top, duration) {
            ...
            let $el = this.el === window ? $('html,body') : $(this.el);
        ...
        scroll: function (left, top, duration) {
            ...
            let $el = this.el === window ? $window : $(this.el);
        ...
        scrollToElement: function (element, paddingLeft, paddingTop, duration) {
            ...
            let rect = (Rect as any).ofElement(element).relativeTo((Rect as any).ofContent(this.el));
    ...
    let callbacksMixIn = {
        ...
        check: function (event) {
            ...
            let value = this.updatedValue(event);
    ...
    extend(FracsCallbacks.prototype, callbacksMixIn, {
        updatedValue: function () {
            ...
            let value = (Fractions as any).of(this.context, this.viewport);
    ...
    extend(ScrollStateCallbacks.prototype, callbacksMixIn, {
        updatedValue: function () {
            ...
            let value = new ScrollState(this.context);
    ...
    let modplug = function (namespace, options) {
        'use strict';
    ...
    modplug(namespace, {
        ...
        statics: {
            ...
            fracs: function (rect, viewport) {
                ...
                return (Fractions as any).of(rect, viewport);
            }
        },
        ...
        methods: {
            ...
            content: function (inContentSpace) {
                ...
                return this.length ? (Rect as any).ofContent(this[0], inContentSpace) : null;
            },
            ...
            envelope: function () {
                ...
                return reduce(this, function (current) {
                    ...
                    let rect = (Rect as any).ofElement(this);
            ...
            fracs: function (action, callback, viewport) {
                ...
                let ns = namespace + '.fracs.' + getId(viewport);
                ...
                return this.length ? (Fractions as any).of(this[0], viewport) : null;
            },
            ...
            min: function (property, callback, viewport) {
                ...
                if (callback) {
                    new GroupCallbacks(this, viewport, property, null).bind(callback);
                    return this;
                }
            ...
            rect: function () {
                ...
                return this.length ? (Rect as any).ofElement(this[0]) : null;
            },
            ...
            viewport: function (inContentSpace) {
                ...
                return this.length ? (Rect as any).ofViewport(this[0], inContentSpace) : null;
            }
        },
...
if (HTMLElement.prototype) {
    (HTMLElement.prototype as any).fracs = function () {
        return ($(this) as any).fracs();
    };
}
