...
interface WorkListHelper {
     ...
     */
     generateRowDefinion(responseListData: WorklistBase,
     ...
     * @returns grid row collection.
     */
     generateTableHeader(responseType: enums.ResponseMode,
     ...
     * @returns grid row collection.
     */
     generateFrozenRowBody(responseListData: WorklistBase,
         responseType: enums.ResponseMode,
     ...
     * @returns grid row collection.
     */
     generateFrozenRowHeader(responseListData: WorklistBase,
         responseType: enums.ResponseMode,
         worklistType: enums.WorklistType,
