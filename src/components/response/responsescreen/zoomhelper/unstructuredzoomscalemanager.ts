...
class UnstructuredZoomScaleManager extends zoomScaleManagerBase {
    ...
    */
     ...
     * @returns
     */
    public getRotatedImageWidth(hasRotatedImage: boolean): number {
...
export = UnstructuredZoomScaleManager;