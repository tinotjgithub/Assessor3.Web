...
class SaveAcetatesDataAction extends dataRetrievalAction {
    ...
    constructor(success: boolean, acetatesList: Immutable.List<Acetate>) {
        super(action.Source.View, actionType.SAVE_ACETATES_DATA_ACTION, success);
