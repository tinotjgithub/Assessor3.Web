 ...
 */
class PromoteToSeedCheckRemarkAction extends dataRetrievalAction {
    ...
    constructor(success: boolean, promoteToSeedReturn: promoteToSeedReturn) {
        super(action.Source.View, actionType.PROMOTE_TO_SEED_VALIDATION, success);
...
export = PromoteToSeedCheckRemarkAction;
